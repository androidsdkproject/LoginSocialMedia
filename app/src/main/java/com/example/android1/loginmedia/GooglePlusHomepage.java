...
public class GooglePlusHomepage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_google_plus_homepage);
        ...
        editor.putString(loginTypeKey, "Google");
        editor.apply();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                editor.clear().apply();
                Intent intent = new Intent(GooglePlusHomepage.this, LoginActivity.class);
